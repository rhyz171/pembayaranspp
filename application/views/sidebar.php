    <a href="<?php echo base_url('dashboard') ?>" class="brand-link">
      <img src="<?php echo base_url(); ?>assets/dist/img/rin.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link active">
              <i class="nav-icon fas fa-star" style="color:cyan"></i>
              <p>
              Dashboard
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('siswa') ?>" class="nav-link">
              <i class="nav-icon fas fa-users" style="color:magenta"></i>
              <p>
                Data Siswa
              </p>
            </a>
